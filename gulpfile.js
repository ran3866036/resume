...
gulp.task('copy-font',function(){
	return gulp.src('./src/font/**/*.css').pipe(gulp.dest('./www/font'));
});
gulp.task('copy-music',function(){
	return gulp.src('./src/music/**').pipe(gulp.dest('./www/music'));
});
...
gulp.task('copy-images',function(){
	return gulp.src('./src/image/**').pipe(gulp.dest('./www/images'));
});
